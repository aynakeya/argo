...
func (c *client) AddTorrent(content string, options ...interface{}) (gid string, err error) {
...
func (c *client) AddTorrentByFilename(filename string, options ...interface{}) (gid string, err error) {
